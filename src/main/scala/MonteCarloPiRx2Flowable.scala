...
object MonteCarloPiRx2Flowable {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val takeLastOne = new Function[Flowable[State], Flowable[State]]() {
      override def apply(t: Flowable[State]) : Flowable[State] = {
        return t.takeLast(1)
      }
    }
